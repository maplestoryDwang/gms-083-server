...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public boolean sendCPQMapLists() {
        ...
        for (int i = 0; i < 6; i++) {
            if (fieldTaken(i)) {
                if (fieldLobbied(i)) {
                    msg += "#b#L" + i + "#嘉年华地图 " + (i + 1) + " (Level: "  // "Carnival field" GMS-like improvement thanks to Jayd (jaydenseah)
                ...
                if (i >= 0 && i <= 3) {
                    msg += "#b#L" + i + "#嘉年华地图 " + (i + 1) + " (2x2) #l\r\n";
                } else {
                    msg += "#b#L" + i + "#嘉年华地图 " + (i + 1) + " (3x3) #l\r\n";
                }
            }
        }
    ...
    public boolean sendCPQMapLists2() {
        ...
        for (int i = 0; i < 3; i++) {
            if (fieldTaken2(i)) {
                if (fieldLobbied2(i)) {
                    msg += "#b#L" + i + "#嘉年华地图 " + (i + 1) + " (Level: "  // "Carnival field" GMS-like improvement thanks to Jayd
